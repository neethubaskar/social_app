...
DATABASES_PORT = config('DATABASES_PORT', '')
...
AUTH_COOKIE_ACCESS = 'social_app_access_token'
# Refresh Token Cookie name. Enables cookies if value is set.
AUTH_COOKIE_REFRESH = 'social_app_refresh_token'
AUTH_COOKIE_SALT = 'user_secure_token'
SESSION_COOKIE_SECURE = False
SESSION_COOKIE_HTTPONLY = False
TOKEN_COOKIE_DOMAIN = 'http://127.0.0.1'
